...
describe("Message", function() {
  var address = "PQJLZiv77J6uiPCrjy1zHW2zxEraNt58dT";
  var badAddress = "PKEFrni7tVdLFq8gPsaW7Qj4aQBErba4xR";
  var privateKey = bitcore.PrivateKey.fromWIF(
    "YVkKNY6WvFPGBwXrth2H6uwxJUj7nDVG2XZetXpSNQsnDW91rPxL"
  );
  var text = "hello, world";
  var signatureString =
    "H0t/xxNAXviBZqtYOsVa189oJzQ8aF4/WEjKDkkH8r/MZ90FI6mTaPkYH0eT+oQAd8zsiTBGL95M/6lEWQlbZnE=";
  ...
  var badSignature = Signature.fromCompact(
    new Buffer(badSignatureString, "base64")
  );
